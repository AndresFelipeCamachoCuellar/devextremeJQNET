...
namespace DemoDevExtremeJQ.Util
{
    public class Connection
    {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    objResponseDB.strResultId = resultId.ToString();
                                    objResponseDB.Count++;
                                }
        ...
        public ResponseDB InsData(string strBaseQuery, object @params, object values)
        {
        ...
        public ResponseDB exectQuery(string strQuery, string[] arrayParam, string[] arrayValue)
        {
            ResponseDB objResponseDB = new ResponseDB
            {
                Resp = true
